...
function App() {
  return (
    <Router>
      <Routes>
        {/* Your landing page containing the search hero and works grid */}
        <Route path="/" element={<Home />} />
        
        {/* Existing search layout for keyword terms */}
...
//     setHasSearched(true);
//     try {
//       console.log("welcome to the try in app.jsx")
//       const response = await axios.get(
//         `https://sastadost.online/api/search?q=${encodeURIComponent(q)}` // for local use this  
